export const Bio = {
  ...
  description:
    "A motivated and dedicated aspiring Software(aspiring indicating as a fresher is it ok) Developer with a strong foundation in problem-solving and a commitment to learning and adapting to new technologies. Eager to apply my skills and initiative to contribute to impactful projects, support organizational goals, and continuously grow in a dynamic development environment.",
  github: "https://github.com/saiyashwanth-dev",
  resume:
    "UUUUUUUUpload resume g doc",
  linkedin: "https://www.linkedin.com/in/sai-yashwanth813/",
